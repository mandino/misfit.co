...
class WC_QV_Custom_Template_Product_Description_Settings extends WC_QV_Admin_UI
{
	 ...
	 */
	public $option_name = 'quick_view_template_product_description_settings';
...
/** 
 * wc_qv_custom_template_product_description_settings_form()
 * Define the callback function to show subtab content
 */
function wc_qv_custom_template_product_description_settings_form() {
	global $wc_qv_custom_template_product_description_settings;
	$wc_qv_custom_template_product_description_settings->settings_form();
}

...
class WC_QV_Custom_Template_ReadMore_Button_Settings extends WC_QV_Admin_UI
{
	 ...
	 */
	public $option_name = 'quick_view_template_readmore_settings';
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Read More Settings successfully saved.', 'wooquickview' ),
				'error_message'		=> __( 'Error: Read More Settings can not save.', 'wooquickview' ),
				'reset_message'		=> __( 'Read More Settings successfully reseted.', 'wooquickview' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'read-more',
			'label'				=> __( 'Read More', 'wooquickview' ),
			'callback_function'	=> 'wc_qv_custom_template_readmore_button_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' => __( 'Read More Button Setup', 'wooquickview' ),
                'type' => 'heading',
           	),
			array(  
				'name' 		=> __( 'Read More Button', 'wooquickview' ),
				'id' 		=> 'show_readmore',
				'class'		=> 'show_readmore',
				'type' 		=> 'onoff_checkbox',
				'default'	=> 0,
			...
			array(
				'name'		=> __( 'Read More Button / Hyperlink', 'wooquickview' ),
                'type' 		=> 'heading',
			...
			array(
            	'name' 		=> __( 'Read More Hyperlink Styling', 'wooquickview' ),
                'type' 		=> 'heading',
			...
			array(  
				...
				'type' 		=> 'text',
				'default'	=> __('Read More', 'wooquickview')
			),
			array(  
			...
			array(
            	'name' 		=> __( 'Read More Button Styling', 'wooquickview' ),
                'type' 		=> 'heading',
...
$(document).ready(function() {
	...
	$(document).on( "a3rev-ui-onoff_checkbox-switch", '.readmore_button_type', function( event, value, status ) {
		...
		if ( status == 'true') {
			...
			$(".readmore_hyperlink_styling_container").slideUp();
		} else {
			$(".readmore_button_styling_container").slideUp();
	...
	$(document).on( "a3rev-ui-onoff_checkbox-switch", '.show_readmore', function( event, value, status ) {
		...
		if ( status == 'true' ) {
			...
			$(".show_readmore_container").slideUp();
			$(".readmore_button_styling_container").slideUp();
			$(".readmore_hyperlink_styling_container").slideUp()
		}
	});
...
/** 
 * wc_qv_custom_template_readmore_button_settings_form()
 * Define the callback function to show subtab content
 */
function wc_qv_custom_template_readmore_button_settings_form() {
	global $wc_qv_custom_template_readmore_button_settings;
	$wc_qv_custom_template_readmore_button_settings->settings_form();
}

...
class WC_Quick_View_Ultimate
{
	...
	public function quick_view_ultimate_wp_enqueue_script(){
		...
		$quick_view_ultimate_type = get_option('quick_view_ultimate_type');
		if ( 'hover' != $quick_view_ultimate_type ) return;

		wp_register_script( 'quick-view-script', WC_QUICK_VIEW_ULTIMATE_JS_URL.'/quick_view_ultimate.js', array('jquery'), WC_QUICK_VIEW_ULTIMATE_VERSION );

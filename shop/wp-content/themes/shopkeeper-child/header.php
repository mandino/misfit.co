...
<head>
	...
	fbq('init', '1602961086680814');
	fbq('track', "PageView");
	
	<?php if (is_product() || is_home() || is_shop()) { ?>
		fbq('track', 'ViewContent');
	<?php } elseif (is_search()) { ?>
		fbq('track', 'Search');
	<?php } elseif (is_cart()) { ?>
		fbq('track', 'AddToCart');
	<?php } elseif (is_wc_endpoint_url( 'order-received' )) { /* Check child theme: /woocommerce/checkout/thankyou.php */ ?>
	...
	src="https://www.facebook.com/tr?id=1602961086680814&ev=PageView&noscript=1"
	/></noscript>
                        ...
                        <div class="top-headers-wrapper">
                            ...
                            <?php if ( isset($shopkeeper_theme_options['main_header_layout']) ) : ?>
                                ...
                                <?php elseif ( $shopkeeper_theme_options['main_header_layout'] == "2" ) : ?>
                                	<?php include_once(get_template_directory() . '/header-centered-2menus.php'); ?>
                                <?php elseif ( $shopkeeper_theme_options['main_header_layout'] == "3" ) : ?>
                                	<?php include_once(get_template_directory() . '/header-centered-menu-under.php'); ?>
								<?php endif; ?>

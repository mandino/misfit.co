...
<header id="masthead" class="site-header" role="banner">
    ...
    <?php endif; ?>    
            ...
            <div class="site-header-wrapper" style="max-width:<?php echo esc_html($header_max_width_style); ?>">
                ...
                <nav class="show-for-large-up main-navigation default-navigation <?php if ( (isset($shopkeeper_theme_options['main_header_navigation_position_header_1'])) ) echo esc_html($shopkeeper_theme_options['main_header_navigation_position_header_1']); ?>" role="navigation">                    
                    <?php 

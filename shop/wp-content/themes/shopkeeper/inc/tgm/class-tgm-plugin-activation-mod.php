...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
    ...
    class TGM_Plugin_Activation {
        ...
        protected function do_plugin_install() {
            ...
            if ( isset( $_GET['plugin'] ) && ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' == $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' == $_GET['tgmpa-update'] ) ) ) {
            ...
            //=========================================================
                ...
                if ( $this->is_automatic ) {
                    ...
                    if ( is_wp_error( $activate ) ) {
                        ...
                        if( isset( $_GET['return_url'] ) ) {
                            echo '<p><a href="' . $_GET['return_url'] . '" title="' . esc_attr( $this->strings['return'] ) . '" target="_parent">' . $this->strings['return'] . '</a></p>';
                        } else {
                ...
                if ( empty( $complete ) ) {
                    echo '<p>' .  sprintf( $this->strings['complete'], '<a href="' . esc_url( add_query_arg( 'page', 'getbowtied_theme_plugins', network_admin_url( 'admin.php' ) ) ) . '" title="' . esc_attr__( 'Return to Plugins Section', 'tgmpa' ) . '">' . __( 'Return to Plugins Section', 'tgmpa' ) . '</a>' ) . '</p>';
        ...
        public function notices() {
            ...
            if ( ! empty( $message ) ) {
                ...
                $show_install_link  = $install_link ? '<a href="' . esc_url( add_query_arg( 'page', 'getbowtied_theme_plugins', network_admin_url( 'admin.php' ) ) ) . '">' . translate_nooped_plural( $this->strings['install_link'], $install_link_count, 'tgmpa' ) . '</a>' : '';
                $show_activate_link = $activate_link ? '<a href="' . esc_url( add_query_arg( 'page', 'getbowtied_theme_plugins', network_admin_url( 'admin.php' ) ) ) . '">' . translate_nooped_plural( $this->strings['activate_link'], $activate_link_count, 'tgmpa' ) . '</a>'  : '';

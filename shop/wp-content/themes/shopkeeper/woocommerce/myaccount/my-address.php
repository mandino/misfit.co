...
<h2 class="my_address_title"><?php echo esc_html($page_title); ?></h2>
    ...
    <div class="shipping_billing_wrapper">
        ...
        <?php foreach ( $get_addresses as $name => $title ) : ?>
            ...
            <div class="medium-6 columns">
                <header class="title">
                    <h3 class="billing_shipping_address_title"><?php echo esc_html($title); ?></h3>
                </header>
                <address>
                    <?php
                ...
                <span class="edit-link">
                    <a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="post-edit-link"><i class="fa fa-pencil"></i><?php _e( 'Edit', 'woocommerce' ); ?></a>
                </span>

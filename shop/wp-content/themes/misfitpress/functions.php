...
/* Below is an include to default custom fields for the posts.*/
include(TEMPLATEPATH . '/library/misfit-journal-functions.php');
...
{
	$settings['pages'] = array('General Settings', 'Shop Slideshow');
...
include(TEMPLATEPATH . '/library/number-convert.php');
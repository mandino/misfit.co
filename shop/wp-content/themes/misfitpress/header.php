...
<head>
	...
	<?php } ?>
		...
		<script type="text/javascript">
			var total = $('.order-total .amount').text().replace("$", "");
				var totalconvertedToNumber = parseFloat(total);
				console.log(totalconvertedToNumber);
			$('#place_order').onClick(function(){
				fbq('track', 'Purchase', {value: totalconvertedToNumber, currency: 'USD'});
			});
		</script>

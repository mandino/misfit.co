	...
	function woo_pagenav() {
		...
		?>
            <div class="nav-entries">
                <?php next_posts_link( '<span class="nav-prev icon fl">'. __( 'Older posts', 'woothemes' ) . '</span>' ); ?>
                <?php previous_posts_link( '<span class="nav-next icon fr">'. __( 'Newer posts', 'woothemes' ) . '</span>' ); ?>
                <div class="fix"></div>
            </div>
		<?php
			} // End IF Statement
	...
	function woo_postnav() { 
		...
		?>
	        <div class="post-entries">
	            <div class="nav-prev icon fl"><?php previous_post_link( '%link', '%title' ) ?></div>
	            <div class="nav-next icon fr"><?php next_post_link( '%link', '%title' ) ?></div>
	            <div class="fix"></div>
	        </div>	
	...
	<div id="connect">
		...
		<div <?php if ( $related_posts != '' ) echo 'class="col-left"'; ?>>
			...
			<div class="social<?php if ( $related_posts == '' AND $woo_options['woo_connect_newsletter_id' ] != "" ) echo ' fr'; ?>">
		   		...
		   		<a href="<?php if ( $woo_options['feed_url'] ) { echo esc_url( $woo_options['feed_url'] ); } else { echo get_bloginfo_rss('rss2_url'); } ?>" class="subscribe" title="RSS"></a>

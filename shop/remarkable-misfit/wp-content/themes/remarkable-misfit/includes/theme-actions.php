...
function woo_custom_styling() {
	...
	if ( !$woo_options['woo_logo'] )
		$output .= '#logo .site-title, #logo .site-description { display:block!important; }' . "\n";
	...
	if ( isset( $woo_options['woo_style_disable'] ) && $woo_options['woo_style_disable'] != 'true' ) :
		...
		if ( $nav_font )
			$output .= 'ul.nav li a, #navigation ul.rss a { ' . woo_generate_font_css( $nav_font ) . ' }' . "\n";	
		if ( $nav_hover )
	        ...
	        while ( $query->have_posts() ) : $query->the_post(); global $post; $shownposts[$count] = $post->ID; $count++;
	           ...
	           $styles = 'width: ' . $args['width'] . 'px;';
	            ...
	            $html .= '<li id="slide-' . $count . '" class="slide" style="' . $styles . '">' . "\n";               
					$html .= '<a href="' . $url . '" title="' . the_title_attribute( array( 'echo' => 0 ) ) . '">' . woo_image( 'width=' . $args['width'] . '&link=img&return=true&noheight=true' ) . '</a>' . "\n";
...
if ( ! function_exists( 'woo_nav_subscribe' ) ) {
	function woo_nav_subscribe() {
		...
		<ul class="rss fr">
			...
			<?php } ?>
			<li class="sub-rss"><a class="icon" href="<?php if ( $woo_options['woo_feed_url'] ) { echo $woo_options['woo_feed_url']; } else { echo get_bloginfo_rss( 'rss2_url' ); } ?>"></a></li>
		</ul>
		<?php }
...
if ( ! function_exists( 'woo_footer_sidebars' ) ) {
	function woo_footer_sidebars() {
		...
		if ( $has_footer_sidebars &&  $total > 0 && !is_page('subscribe') ) {		
?>

	<div class="mailchimp-form-widgets" id="mailchimp-subscribe">
			
		<div class="fl">
			
			<h3><?php the_field('home_form_sub_title' , 'option'); ?></h3>
			<h2><?php the_field('home_form_title' , 'option'); ?></h2>
		...
		<div class="fr">
			...
			<div id="mc_embed_signup-1">
				...
				$home_mailchimp_email_link = get_field('home_mailchimp_email_link', 'option');
					
				echo '
				<form action="'.$home_mailchimp_email_link.'" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" style="font: normal 100% proxima-nova, sans-serif;font-size: 10px;">
				';
				?>

					<fieldset style="-moz-border-radius: 4px;border-radius: 4px;-webkit-border-radius: 4px;border: 1px solid #ccc;padding-top: 1.5em;margin: 0 0 10px;background-color: #fff;color: #000;text-align: left;">
					<div class="mc-field-group" style="margin-right: 5px !important; clear: both;overflow: hidden;">
					<label for="mce-FNAME" style="display: none; block;margin: .3em 0;line-height: 1em;font-weight: bold;">Name</label>
					<input type="text" onblur="if (this.value == '') {this.value = 'Name';}" onfocus="if (this.value == 'Name') {this.value = '';}" value="Name" name="MMERGE1" class="required" id="mce-FNAME" style="margin-right: 1.5em;float: left;z-index: 999;">
					</div>
					<div class="mc-field-group" style="clear: both;overflow: hidden;">
					<label for="mce-EMAIL" style="display: none; block;margin: .3em 0;line-height: 1em;font-weight: bold;">Email</label>
					<input type="text" onblur="if (this.value == '') {this.value = 'Email';}" onfocus="if (this.value == 'Email') {this.value = '';}" value="Email" name="EMAIL" class="required email" id="mce-EMAIL" style="margin-right: 1.5em;float: right;z-index: 999;">
					</div>
					...
					<!-- <div class="mc-field-group input-group">
						<ul>
							<li><label class="label_check"><input type="checkbox" value="1" name="group[9141][1]" id="mce-group[9141]-9141-0"></label></li>
							<li class="lft"><label for="mce-group[9141]-9141-0"><p>Do you agree to receive marketing messages from Apperian and from any of Apperian&rsquo;s partners with whom you sign-up for a co-branded online conference?  For a copy of the Apperian Privacy Policy, please click <a class="link-newsletter" href="http://www.apperian.com/apperian-privacy-policy" target="_blank">here</a>.</p></label></li>
						</ul>
					</div> -->
								
							<div style="margin: 0 auto 5px; float: right;"><input type="submit" value="+" name="subscribe" id="mc-embedded-subscribe" class="btn button" style="clear: both;width: auto;display: block;margin: 1em 0 1em 5%;"></div>
			...
			<p><?php the_field('home_form_disclaimer' , 'option'); ?></p>

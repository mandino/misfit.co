(function($){
    SlideDeckLens['remarkable'] = function(slidedeck){
    ...
    $(document).ready(function(){
        $('.lens-remarkable .slidedeck').each(function(){
            if(typeof($.data(this, 'lens-remarkable')) == 'undefined' || $.data(this, 'lens-remarkable') == null){
                $.data(this, 'lens-remarkable', new SlideDeckLens['remarkable'](this));
            }
        });
    });
})(jQuery);
		...
		<div class="container__inner">
			<ul class="slide__container">
				...
				<li class="slide__item slide__item--slide1 slide__item--active">
					...
					<div class="slide__content content-1 content-medium">
				...
				<li class="slide__item slide__item--slide4">
					<div class="slide__content content-4 content-large">
				...
				<li class="slide__item slide__item--slide6">
					<div class="slide__content content-6 content-custom">
				...
				<li class="slide__item slide__item--slide7">
					<div class="slide__content content-7 content-custom">
				...
				<div class="slide__nav-inner">
						...
						<ul class="slide__nav-list">
							<li class="slide__nav-item">
								<a href="#" class="slide__nav-button button-1">
									...
									<div class="slide__nav-iconwrap show-desktop">
										<img class="slide__nav-icon" src="~assets/images/studio_misfit_logo.png" alt="studio misfit logo">
									</div>
									<div class="slide__nav-iconwrap show-mobile">
										<img class="slide__nav-icon" src="~assets/images/studio_misfit_asterisk-thin.png" alt="studio misfit logo">
									</div>
							...
							<li class="slide__nav-item">
								<a href="#" class="slide__nav-button button-2">
									...
									<h4 class="slide__nav-text slide__nav-text--right text-2">Creative Agency</h4>
								</a>
							</li>
							...
							<li class="slide__nav-item">
								<a href="#" class="slide__nav-button button-5">
									...
									<h4 class="slide__nav-text slide__nav-text--right text-5">Philanthropy</h4>
								</a>
							</li>
							...
							<li class="slide__nav-item">
								<a href="#" class="slide__nav-button button-6">
									...
									<h4 class="slide__nav-text slide__nav-text--left">I</h4>
									<h4 class="slide__nav-text slide__nav-text--right text-6">Art + Retail</h4>
								</a>
							</li>
							...
							<li class="slide__nav-item">
								<a href="#" class="slide__nav-button button-7">
									...
									<h4 class="slide__nav-text slide__nav-text--right text-7">Ventures + Accelerator</h4>
								</a>
							</li>
						</ul>
					</div>
					...
					<div class="slide__nav-social">
						<div class="slide__nav-social-ico">
							<a href="https://www.instagram.com/misfitinc/" target="_blank">
